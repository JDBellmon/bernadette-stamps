// partial-ui-footernav-sm.component.ts

import { Component, OnInit } from '@angular/core';
import { ActivatedRoute } from '@angular/router';

@Component({
  selector: 'app-partial-ui-footernav-sm',
  templateUrl: './partial-ui-footernav-sm.component.html',
  styleUrls: ['./partial-ui-footernav-sm.component.scss']
})
export class PartialUiFooternavSmComponent implements OnInit {
